...
export default function MembershipPage() {
  ...
  const goToCheckout = () => {
    ...
    router.push(`/checkout?plan_id=${selectedPlanId}&billing=${billingCycle}`);
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-16 px-4 sm:px-6 lg:px-8 relative">
      <div className="max-w-7xl mx-auto text-center">
        ...
        {selectedPlanId && (
          <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-md px-6 py-4 flex flex-col sm:flex-row justify-between items-center z-50">
            <div className="text-sm text-gray-700 mb-2 sm:mb-0 text-center sm:text-left">
              ...
              <span className="text-green-600 font-bold">
                ...
                )?.toLocaleString(undefined, { maximumFractionDigits: 0 })}/{billingCycle}
              </span>
            </div>
            <button
