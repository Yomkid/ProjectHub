    ...
    <div className="min-h-screen bg-gray-100 p-10">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <PlanCard
            title="Student"
            price="₦35,000/₦30,000 per year"
            note="Save up to ₦10,000"
            features={[
              ...features,
...
const PlanCard = ({
  ...
  <div className="bg-white shadow-lg p-6 text-left">
    ...
    <button className="mt-6 w-full py-2 bg-green-600 text-white  hover:bg-green-700">
      Select Plan
    </button>
  </div>
);
