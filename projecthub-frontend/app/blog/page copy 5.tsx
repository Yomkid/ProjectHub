...
const downloadArticleAsPDF = async (contentRef: React.RefObject<HTMLDivElement | null>) => {
  const element = contentRef.current;
  if (!element) {
    throw new Error("Content element is not available.");
  }
  ...
  pdf.save('face-recognition-article.pdf');
};
                ...
                <div className="lg:w-2/4 bg-white shadow-md p-6 mb-6 flex flex-col" ref={contentRef}>
                    ...
                    <div className="flex flex-col gap-2 mb-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            <button
                                onClick={() => downloadArticleAsPDF(contentRef)}
                                className="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 self-start mb-4"
                            >
                                Download Article
                            </button>
