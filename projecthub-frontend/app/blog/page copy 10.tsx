                ...
                <div className="flex items-center justify-between">
                    <a
                        ...
                        className={`block py-1 px-2 rounded transition-colors duration-200 
                            ${activeId === item.id ? 'bg-green-50 text-green-600 font-medium w-full' : 'text-gray-700 hover:text-green-600'}
                        ...
                        onClick={(e) => {
                            ...
                            if (targetElement) {
                                const yOffset = -90; // adjust this to match your navbar height
