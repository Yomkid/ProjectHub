            ...
            <div className="bg-white shadow-md p-6 mb-6 sticky top-0 z-50 flex flex-col">
                <div>
                    ...
                    <div className="flex mt-4 space-x-2">
                        ...
                        <button className="bg-gray-50 px-3 py-1 border flex items-center space-x-1"> <FileText size={18} className="text-gray-700" /> <span className="font-semibold"> {typeof setTotalPages === 'function' ? '0' : ''} pages</span> </button>
                        ...
                        <Worker workerUrl="/pdf.worker.js">
                            ...
                            <div className="flex-1 w-full overflow-auto relative">
                                <Viewer
                                    ...
                                    onDocumentLoadSuccess={(pdf: { numPages: any; }) => setTotalPages(pdf.numPages)} theme={{
                            ...
                            {documents.map((doc, index) => (
                                ...
                                >
                                    ...
                                    <div className="w-16 h-20">
                                        <Thumbnails fileUrl={doc.pdfUrl} pageIndex={0}/>
                                    </div>
